...
<head>
<title>Koliba gardens - vily v lukratívnej časti Bratislavy</title>
                ...
                <div class="container-fluid">
                    <div class="col-xs-12 ground-color text-center">
                        <div class="container-error-404">
                            <div class="clip"><div class=""><span class="digit thirdDigit"></span></div></div>
                            <div class="clip"><div class=""><span class="digit secondDigit"></span></div></div>
                            <div class="clip"><div class=""><span class="digit firstDigit"></span></div></div>
                           
                        </div>
                        <h2 class="h1">Stránka sa nenašla.</h2>
                        <h2 class="h1"> <a href="/" class="x">Naspäť na hlavnú stránku</a></h2>
						
                    </div>
                </div>
            </div>
        <!-- Error Page -->
</body style="width:100%;display:block;margin-left:auto;margin-right:auto;">
<style>
*
{
